...
public class Main {
    public static void main(String[] args) {
        ...
        Zoologico zoo = new Zoologico(
                "Zoo Catolica",aquaticos,terrestre,aereos);

        //System.out.println(zoo);

        Pantera baguera = new Pantera("Felinae","Floresta","Javali","Baguera",
                "preto",false);
        ...
        Tubarao tutubarao = new Tubarao("Tutubarao","M. owstoni","Mitsukurinidae",
                3,"Salgada","Carnivora",true,true);

        System.out.println(tutubarao);
